...
contract ERC20Exchange is ERC721, AccessControl, SignedHashProtection {
    ...
    address internal currentERC20;
    uint256 internal purchasePeriod;
    string internal baseURI;
    string internal metadataExtension;
    ...
    function setPurchasePeriod(uint256 newTime) public onlyRole(ADMIN) {
    ...
    function mint(uint256 index, uint256 erc20Price, bytes memory licenseHash) public {
